...
Information about the CKB cohort data is available at
[www.ckbiobank.org/data-access/data-overview](https://www.ckbiobank.org/data-access/data-overview).
...
This package includes the following entirely synthetic data sets, which
have similar structure and variable names to real CKB data:
...
A `ckbtools_participant_data` data set is also included in the package,
which is derived from the synthetic raw data as below.
